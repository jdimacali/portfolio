...
const Buttons = ({ project }: ButtonsProps) => {
  return (
    <div className="flex flex-col md:flex-row justify-between gap-8 items-center ">
      ...
      <Link
        className="cursor-pointer text-center bg-gray-900 text-white sm:px-20 px-5 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 
